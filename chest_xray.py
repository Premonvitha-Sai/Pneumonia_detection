...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setStyleSheet("background-color: #b4a7d6;")
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "CHEST X_RAY PNEUMONIA DETECTION "))
        self.label.setToolTip(_translate("MainWindow", "<html><head/><body><p><img src=\":/newPrefix/lung.gif\"/></p></body></html>"))
        self.label_2.setText(_translate("MainWindow", "Please Upload X_RAY to Detect Pneumonia"))
    ...
    def upload_image(self):
        ...
        img_file=image_utils.load_img(path,target_size=(224,224))
        x=image_utils.img_to_array(img_file)
    ...
    def predict_result(self):
        print(result)
        if result[0][0]>0.5:
            print("Result is Normal.You are ok")
            speak("Result is Normal You are ok")
        else:
            print("Affected By PNEUMONIA. Treatment Required.")
            speak("Affected By PNEUMONIA Treatment Required.")
